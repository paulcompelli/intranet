...
<body>
    ...
    <div>
     ...
     <h3> Please log in with your staff details</h3>
     <br />
        <asp:Login ID="Login1" runat="server" DestinationPageUrl="About.aspx" 
            BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" 
            Font-Names="Verdana" Font-Size="10pt" Height="274px" Width="331px">
